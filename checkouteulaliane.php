    ...
    <div class="container-fluid custom-container" style="width: 80%;">
      <form action="#" method="POST">
        <div class="form-container">
          ...
          <input type="text" class="form-control" name="nm_entrega" required>

          <label class="form-label">Telefone</label>
          <input type="text" class="form-control" name="tel_e" required>

          <label class="form-label">Forma de pagamento</label>
          <select class="form-control" name="formp_e" required>
          ...
          <div class="mb-3 mt-2 text-center">
            <button type="button" class="btn btn-primary"   id="sair" >Finalizar Compra</button>
...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO entrega (tel_e, formpag_e, cep_e) VALUES (:tel, :formpag, :cep)");
